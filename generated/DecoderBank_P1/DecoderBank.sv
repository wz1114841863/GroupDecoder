...
module RRArbiter1_MetaReqPayload(	// src/main/scala/chisel3/util/Arbiter.scala:127:7
  ...
  assign io_out_bits_addr = io_in_0_bits_addr;	// src/main/scala/chisel3/util/Arbiter.scala:127:7
endmodule

module RRArbiter1_StreamReqPayload(	// src/main/scala/chisel3/util/Arbiter.scala:127:7
  input         io_in_0_valid,	// src/main/scala/chisel3/util/Arbiter.scala:52:14
...
module DecoderBank(	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7
  ...
  always @(posedge clock) begin	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7
    automatic logic _GEN_1;	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:175:27, :265:19, :269:38, :273:30
    _GEN_1 = io_start_req_ready_0 & io_start_req_valid;	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:175:27, :265:19, :269:38, :273:30
    if (reset) begin	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7
      ...
      automatic logic [3:0][1:0] _GEN_2;	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:167:24, :265:19, :269:38, :339:38, :346:19
      _GEN_2 =
        {{state},
         {2'h0},
         {groups_decoded_per_core_0 == groups_total_per_core_0 ? 2'h2 : state},
         {io_start_req_valid ? 2'h1 : state}};	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7, :167:24, :170:42, :171:40, :265:19, :269:38, :270:23, :322:59, :339:38, :340:23, :346:19
      state <= _GEN_2[state];	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:167:24, :265:19, :269:38, :339:38, :346:19
      if (io_start_req_ready_0) begin	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:265:19
        if (io_start_req_valid)	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:72:16
          groups_decoded_per_core_0 <= 8'h0;	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:170:42
        ...
        if (_GEN)	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:265:19
          core_is_busy_0 <=
      ...
      if (_GEN_1)	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:175:27, :265:19, :269:38, :273:30
        groups_total_per_core_0 <= io_start_req_bits_num_groups_to_decode[7:0];	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:171:40, :281:{46,63}
    end
    if (_GEN_1)	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:175:27, :265:19, :269:38, :273:30
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7
    ...
    initial begin	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7
        ...
        groups_total_per_core_0 = _RANDOM[2'h1][17:10];	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7, :167:24, :171:40
        core_is_busy_0 = _RANDOM[2'h1][18];	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7, :167:24, :174:31
        base_idx_reg = {_RANDOM[2'h1][31:19], _RANDOM[2'h2][2:0]};	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7, :167:24, :175:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  GRDecoderCore GRDecoderCore (	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:79:36
    ...
    .io_group_index               (base_idx_reg + {8'h0, groups_decoded_per_core_0}),	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:170:42, :175:27, :246:49
    ...
    .io_meta_resp_valid           (_meta_arb_io_out_valid),	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:125:26
    .io_meta_resp_start_byte_addr (_meta_sram_ext_R0_data[39:8]),	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:86:24
    .io_meta_resp_zero_point      (_meta_sram_ext_R0_data[7:0]),	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:86:24
    .io_stream_req_valid          (_GRDecoderCore_io_stream_req_valid),
    .io_stream_req_addr           (_GRDecoderCore_io_stream_req_addr),
    .io_stream_resp_valid         (_stream_arb_io_out_valid),	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:126:28
    .io_stream_resp_data          (_shared_cache_ext_R0_data),	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:94:27
  ...
  RRArbiter1_MetaReqPayload meta_arb (	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:125:26
  ...
  RRArbiter1_StreamReqPayload stream_arb (	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:126:28
  ...
  assign io_meta_write_outputs_0_valid = _meta_arb_io_out_valid;	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7, :125:26
  assign io_meta_write_outputs_0_zp = _meta_sram_ext_R0_data[7:0];	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7, :86:24
