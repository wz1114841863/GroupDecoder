...
module RRArbiter2_MetaReqPayload(	// src/main/scala/chisel3/util/Arbiter.scala:127:7
  ...
  assign io_chosen_choice =
    io_in_1_valid & ~ctrl_validMask_grantMask_lastGrant | ~io_in_0_valid;	// src/main/scala/chisel3/util/Arbiter.scala:88:14, :90:49, :91:76, :98:41, :100:{26,35}, :102:{24,33}
...
module RRArbiter2_StreamReqPayload(	// src/main/scala/chisel3/util/Arbiter.scala:127:7
  input         clock,	// src/main/scala/chisel3/util/Arbiter.scala:127:7
                io_in_0_valid,	// src/main/scala/chisel3/util/Arbiter.scala:52:14
...
module DecoderBank(	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7
  ...
  wire        _stream_arb_io_chosen;	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:126:28
  ...
  wire        _meta_arb_io_chosen;	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:125:26
  ...
  assign write_mask_0 = io_load_stream_bits_addr[2:0] == 3'h0;	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:109:36, :115:59
  assign write_mask_1 = io_load_stream_bits_addr[2:0] == 3'h1;	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:109:36, :115:59
  ...
  assign write_mask_4 = io_load_stream_bits_addr[2:0] == 3'h4;	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:109:36, :115:59
  ...
  wire        decoders_0_meta_resp_valid = _meta_arb_io_out_valid & ~_meta_arb_io_chosen;	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:125:26, :191:46, :195:55
  wire [7:0]  decoders_0_meta_resp_zero_point =
    _meta_arb_io_chosen ? 8'h0 : _meta_sram_ext_R0_data[7:0];	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:86:24, :125:26, :202:48
  wire        decoders_1_meta_resp_valid = _meta_arb_io_out_valid & _meta_arb_io_chosen;	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:125:26, :195:55
  wire [7:0]  decoders_1_meta_resp_zero_point =
    _meta_arb_io_chosen ? _meta_sram_ext_R0_data[7:0] : 8'h0;	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:86:24, :125:26, :202:48
  ...
  always @(posedge clock) begin	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7
    automatic logic _GEN_2;	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:175:27, :265:19, :269:38, :273:30
    _GEN_2 = io_start_req_ready_0 & io_start_req_valid;	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:175:27, :265:19, :269:38, :273:30
    if (reset) begin	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7
      ...
      automatic logic [3:0][1:0] _GEN_3;	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:167:24, :265:19, :269:38, :339:38, :346:19
      _GEN_3 =
        {{state},
         {2'h0},
      ...
      state <= _GEN_3[state];	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:167:24, :265:19, :269:38, :339:38, :346:19
      ...
      if (_GEN_2) begin	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:175:27, :265:19, :269:38, :273:30
        automatic logic [15:0] remainder = io_start_req_bits_num_groups_to_decode % 16'h2;	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:278:44
        automatic logic [15:0] base_per_core =
          io_start_req_bits_num_groups_to_decode / 16'h2;	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:277:48
        groups_total_per_core_0 <= base_per_core[7:0] + {7'h0, |(remainder[1:0])};	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:171:40, :277:48, :278:44, :281:63, :282:27
        groups_total_per_core_1 <= base_per_core[7:0] + {7'h0, remainder[1]};	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:171:40, :277:48, :278:44, :281:63, :282:27
      end
    end
    if (_GEN_2)	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:175:27, :265:19, :269:38, :273:30
  ...
  `ifdef ENABLE_INITIAL_REG_	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7
    ...
    initial begin	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7
      automatic logic [31:0] _RANDOM[0:2];	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7
      ...
      `ifdef RANDOMIZE_REG_INIT	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7
        ...
        groups_total_per_core_0 = _RANDOM[2'h1][25:18];	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7, :167:24, :171:40
        groups_total_per_core_1 = {_RANDOM[2'h1][31:26], _RANDOM[2'h2][1:0]};	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7, :167:24, :171:40
        core_is_busy_0 = _RANDOM[2'h2][2];	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7, :171:40, :174:31
        core_is_busy_1 = _RANDOM[2'h2][3];	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7, :171:40, :174:31
        base_idx_reg = _RANDOM[2'h2][19:4];	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:71:7, :171:40, :175:27
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  GRDecoderCore GRDecoderCore (	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:79:36
    ...
    .io_group_index
      (base_idx_reg + {7'h0, groups_decoded_per_core_0, 1'h0}),	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:170:42, :175:27, :246:49
    ...
    .io_meta_resp_start_byte_addr
      (_meta_arb_io_chosen ? 32'h0 : _meta_sram_ext_R0_data[39:8]),	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:86:24, :125:26, :197:53
    ...
    .io_stream_resp_data
      (_stream_arb_io_chosen ? 64'h0 : _shared_cache_ext_R0_data),	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:94:27, :126:28, :211:44
  ...
  GRDecoderCore GRDecoderCore_1 (	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:79:36
    ...
    .io_group_index
      (base_idx_reg + {7'h0, groups_decoded_per_core_1, 1'h0} + 16'h1),	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:170:42, :175:27, :246:49, :248:20
    ...
    .io_meta_resp_start_byte_addr
      (_meta_arb_io_chosen ? _meta_sram_ext_R0_data[39:8] : 32'h0),	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:86:24, :125:26, :197:53
    ...
    .io_stream_resp_valid         (_stream_arb_io_out_valid & _stream_arb_io_chosen),	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:126:28, :209:59
    .io_stream_resp_data
      (_stream_arb_io_chosen ? _shared_cache_ext_R0_data : 64'h0),	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:94:27, :126:28, :211:44
  ...
  RRArbiter2_MetaReqPayload meta_arb (	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:125:26
    .clock             (clock),
  ...
  RRArbiter2_StreamReqPayload stream_arb (	// src/main/scala/gr_accelerator/decoder/DecoderBank.scala:126:28
    .clock             (clock),
