...
```sh
git clone git@github.com:wz1114841863/RearrangementDifference.git
cd RearrangementDifference
```
...
#### Commit your changes
```sh
git commit -m 'Starting RearrangementDifference'
...
```sh
./mill RearrangementDifference.test
```
